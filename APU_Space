...
Firmware development and integration were carried out using **STM32CubeIDE**, targeting the dual-core H755ZI board. Wireless communication between the onboard computer (TX) and the ground station (RX) was implemented using **EBYTE LoRa modules** operating at **915 MHz**.
...
Sensor data acquired by the onboard computer is transmitted to the ground station and simultaneously stored on the SD card for further analysis.
...
These results demonstrate the feasibility of the proposed OBC architecture for experimental rocket applications.
...
- **libraries/**: Sensor and peripheral libraries located at  
  `OBC/code/workspace_STM32/APU/CM4/Peripheral`
...
- **Programming Languages**:
  ...
  - C++
- **Libraries**:
  - Respective libraries for each sensor and module
